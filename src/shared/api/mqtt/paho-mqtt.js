/*
* All customisation made for PROSTIR project is commented with '[CUSTOM]' descriptor
*/
 ...
 */
//// VARIABLES
let PahoClient, PahoMessage; // PahoMQTT
/* jshint shadow:true */
(function ExportLibrary(root, factory) {
	...
	// }
	let PahoMQTT = factory(); // [CUSTOM] Web-pack has some conflicts with original
	// ({Client:PahoClient, Message:PahoMessage} = PahoMQTT);
	PahoClient = PahoMQTT.Client;
	PahoMessage = PahoMQTT.Message;
})(
...
//    	    	break;
	...
	function decodeMessage(input,pos) {
		...
		switch(type) {
			...
			case MESSAGE_TYPE.PUBLISH:
				...
				var message = new Message(input.subarray(pos, endPos)); // [CUSTOM] Original has: `new Paho.MQTT.Message`
	...
	ClientImpl.prototype.send = function (message) {
		...
		var wireMessage = new WireMessage(MESSAGE_TYPE.PUBLISH); // [CUSTOM] 'var' declaration added - Alex Seleznov
		wireMessage.payloadMessage = message;
	...
	ClientImpl.prototype.disconnect = function () {
		...
		let wireMessage = new WireMessage(MESSAGE_TYPE.DISCONNECT); // [CUSTOM] 'let' declaration added - Alex Seleznov
	...
	ClientImpl.prototype.restore = function(key) {
		...
		switch(storedMessage.type) {
		  case MESSAGE_TYPE.PUBLISH:
			  ...
			  var payloadMessage = new Message(byteStream); // [CUSTOM] Original has: `new Paho.MQTT.Message`
...
export {PahoClient, PahoMessage};
// window.Paho = {MQTT: PahoMQTT};
